    ...
    <div class="dx-auth-wrap">
        <div class="dx-auth-card">
            <div class="dx-auth-inner">
                ...
                <div class="dx-brand">
                    <div class="dx-badge">New Account</div>
                    <div class="dx-brand-title">
                        Create your <span>DawnEX</span> account
                    </div>
                    <div class="dx-brand-sub">
                        Join the platform and start your AI trading journey with secure access, wallet control, and market tools in one place.
                    </div>
                </div>
                ...
                <div class="dx-note">
                    Use a valid email address and choose a strong password to keep your account secure.
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="dx-field">
                        <x-input-label for="name" :value="__('Name')" class="dx-label" />
                        <x-text-input
                            id="name"
                            class="dx-input"
                            type="text"
                        ...
                        />
                        <x-input-error :messages="$errors->get('name')" class="dx-error" />
                    </div>
                    ...
                    <div class="dx-field">
                        <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="dx-label" />
                        <x-text-input
                        ...
                        />
                        <x-input-error :messages="$errors->get('password_confirmation')" class="dx-error" />
                    </div>
